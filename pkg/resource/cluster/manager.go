...
// +kubebuilder:rbac:groups=dsql.services.k8s.aws,resources=clusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dsql.services.k8s.aws,resources=clusters/status,verbs=get;update;patch

var lateInitializeFieldNames = []string{"DeletionProtectionEnabled"}
...
func (rm *resourceManager) incompleteLateInitialization(
	...
	if ko.Spec.DeletionProtectionEnabled == nil {
		return true
	}
	return false
}
...
func (rm *resourceManager) lateInitializeFromReadOneOutput(
	...
	if observedKo.Spec.DeletionProtectionEnabled != nil && latestKo.Spec.DeletionProtectionEnabled == nil {
		latestKo.Spec.DeletionProtectionEnabled = observedKo.Spec.DeletionProtectionEnabled
	}
...
func (rm *resourceManager) IsSynced(ctx context.Context, res acktypes.AWSResource) (bool, error) {
	...
	statusCandidates := []string{"ACTIVE", "IDLE", "INACTIVE"}
